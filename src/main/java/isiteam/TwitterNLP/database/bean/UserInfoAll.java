 ...
 */
@Entity
@Table(name = "user_info_all", catalog = "twittercrawler", uniqueConstraints = @UniqueConstraint(columnNames = {
		"userId", "crawledNum" }))
public class UserInfoAll implements java.io.Serializable {
	...
	/** full constructor */
	public UserInfoAll(String userId, String screenName, String name,
