...
@Table(name="tweet_info"
    ,catalog="twittercrawler"
, uniqueConstraints = @UniqueConstraint(columnNames="tweetId")
)
...
public class TweetInfo  implements java.io.Serializable {
    ...
    /** full constructor */
    public TweetInfo(String tweetId, String userId, String screenName, Timestamp createdAt, String text, Integer retweetCount, String source, Integer isFavorited, String geoLocation, String place, String inReplyToStatusId, String inReplyToUserId, String inReplyToScreenName, String inRetweetToStatusId, String inRetweetToUserId, String inRetweetToScreenName, Timestamp inRetweetCreatedAt, Integer inRetweetCount, String allText, Timestamp insertTime) {
        this.tweetId = tweetId;
        this.userId = userId;
